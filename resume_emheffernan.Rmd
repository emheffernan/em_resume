...
tribble(
  ...
  "University of Toronto", "2020-2024", "PhD, Cognitive Neuroscience", "Toronto, Ontario", "\\textbf{\\textcolor{mygrey}{Funding:}} NSERC CGS-D (105,000 CAD)",
...
tribble(
 ...
 "Copy Editor and Content Writer", "Learneo", "January", 2019, "Present", NA, "Remote", "Since I started writing research content at Quillbot, traffic to research category articles has grown by 300\\%, and \\underline{\\href{https://quillbot.com/blog/author/emily/}{my articles}} consistently achieve high rankings on Google (4 currently ranked in the top 10) with an 8.5\\% click-through rate to internal pages.",
...
tribble(
 ...
 "Learning exceptions to the rule in human and model \\href{https://github.com/emheffernan/exception_learning_project}{\\faGithub}", "Mack Lab", "\\textbf{\\textcolor{mygrey}{Objective:}} To better understand how people learn exceptions to the rule (e.g., bats fly, but aren't birds) and whether a neural network model of the hippocampus captures human behaviour.",
  "Learning exceptions to the rule in human and model \\href{https://github.com/emheffernan/exception_learning_project}{\\faGithub}", "Mack Lab", "\\textbf{\\textcolor{mygrey}{What I Did:}} I developed a behavioural task using Psychopy (Python), collected data, and analyzed performance in R using mixed-effects logistic regression. I also simulated my task with a neural network and explored activation in its hidden layers using representational similarity analysis.",
 ...
 "Using mouse-tracking to explore attentional shifts during learning \\href{https://github.com/emheffernan/mousetracking_study}{\\faGithub}", "Mack Lab", "\\textbf{\\textcolor{mygrey}{What I Did:}} I designed a mouse-tracking task in JavaScript. Participants explored stimuli using their computer mouse and sorted them into categories. In R, I analyzed the entropy of mouse movements.",
 "Using mouse-tracking to explore attentional shifts during learning \\href{https://github.com/emheffernan/mousetracking_study}{\\faGithub}", "Mack Lab", "\\textbf{\\textcolor{mygrey}{Outcomes:}} Surprising information does elicit a shift in attention, but this shift only benefits learning if the surprising item is similar to previously encountered items. I presented a talk on this work at the 2023 CSBBCS Conference and am currently preparing a manuscript for publication.",
